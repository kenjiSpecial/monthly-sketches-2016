...
var ParticleContainer = function (maxParticles, particleSystem) {
    ...
    for (var i = 0; i < this.PARTICLE_COUNT; i++) {
        ...
        this.particleVelColSizeLife[i * 4 + 2] = 10 * Math.random() + 4; //size
        this.particleVelColSizeLife[i * 4 + 3] = 1.0 + 0.5 * Math.random(); //lifespan
    }
...
ParticleContainer.prototype.start = function() {
    this.count = 1;
    for (var i = 0; i < this.PARTICLE_COUNT; i++) {
        this.particlePositionsStartTime[i * 4 + 3] = this.particleRandom; // + this.particleRandom * this.count + 3.0 * (this.count-1); //startTime
    }
    /**
...
ParticleContainer.prototype.update = function(time) {
    ...
    //console.log(this.particleRandom );
    if(this.time > this.particleRandom + 3.5) {
        this.time -= this.particleRandom + 3.5;
    }
